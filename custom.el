...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 100 :foundry "unknown" :family "Monaco"))))
 ...
 '(org-headline-done ((((class color) (min-colors 89)) (:foreground "#859900"))) t)
 '(org-level-1 ((t (:foreground "#ffffff" :height 1.5))) t)
 '(org-level-2 ((t (:inherit outline-2 :foreground "#ffffff"))) t)
 '(org-level-3 ((t (:inherit outline-3 :foreground "#ffffff"))) t))
