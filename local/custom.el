...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("/Users/tusk/Google Drive/Organize/PERSONAL" "/home/tusk/secure/todo.org")))
 ...
 '(todotxt-file "/Users/tusk/.todo/todo.txt" nil (todotxt))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#272822" :foreground "#F8F8F2" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 100 :width normal :foundry "apple" :family "Monaco")))))
